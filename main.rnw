%% Time-stamp: <2016-05-13 14:31:37 chl>
...
An alternative representation of this three-way Table is provided by
\texttt{ftable}, in long or wide format, see Table xx for the wide format:
<<eval=1>>=
ftable(d)

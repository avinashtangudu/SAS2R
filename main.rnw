%% Time-stamp: <2016-05-26 12:43:53 chl>
...
In comparison, a Type II or Type III ANOVA would yield non-significant result
about the effect of drug on change scores.
<<>>=
